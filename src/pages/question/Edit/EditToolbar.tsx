...
const EditToolbar: FC = () => {
  ...
  const { selectId:selectedId, componentList, selectComponent:selectedComponent, copiedComponent } = useGetComponentsInfo()
  const { isLock } = selectedComponent || {}
  const length = componentList.length
  const selectedIndex = componentList.findIndex((c:any) => c.fe_id === selectedId)
